  ...
  methods: {
    ...
    initImg() {
      const img = this.createImg(() => {
        ...
        console.log(ImageData, 11111111);
        this.block.width = L;
    ...
    bindEvents() {
      ...
      document.addEventListener("mouseup", e => {
        ...
        console.log(spliced, TuringTest, 3333);
        if (spliced) {
          if (TuringTest) {
            // succ
    ...
    touchEndEvent(e) {
      ...
      const { spliced, TuringTest } = this.verify();
      console.log(spliced, TuringTest, 1111);
      if (spliced) {
        if (TuringTest) {
          // succ
          this.containerSuccess = true;
...
.slide-verify-refresh-icon {
  ...
  height: 34px;
  cursor: pointer;
  background: url("./logo.png") 0 -437px;
...
.slide-verify-slider-mask-item-icon {
  ...
  width: 14px;
  height: 12px;
  background: url("./logo.png") 0 -26px;
  background-size: 34px 471px;
}
